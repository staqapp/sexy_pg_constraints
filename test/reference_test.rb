...
class ReferenceTest < SexyPgConstraintsTest
  def test_reference
    ActiveRecord::Migration.add_constraint :books, :author_id, :reference => {:authors => :id}
    ...
    ActiveRecord::Migration.drop_constraint :books, :author_id, :reference
  ...
  def test_reference_on_a_column_whose_name_is_a_sql_keyword
    ActiveRecord::Migration.add_constraint :books, :from, :reference => {:authors => :id}
    ...
    ActiveRecord::Migration.drop_constraint :books, :from, :reference
  ...
  def test_reference_with_on_delete
    ActiveRecord::Migration.add_constraint :books, :author_id, :reference => {:authors => :id, :on_delete => :cascade}
